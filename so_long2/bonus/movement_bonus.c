...
/*   Updated: 2022/02/26 21:27:38 by slammari         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	loop_enemy(t_map *map)
{
	static int	i = 0;

	if (i < 10)
	{
		print_map(map, map->img.enemy1);
		i++;
	}
	else if (i < 20)
	{
		print_map(map, map->img.enemy2);
		i++;
	}
	else
	{
